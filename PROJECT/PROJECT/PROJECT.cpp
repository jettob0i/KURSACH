...
public:
    ...
    void getPlayerInput() {
        if (activePlayer == 1) {
            ...
            // Reset projectile parameters when switching active player
    ...
    void updateGame(int value) {
        if (projectile1.shooting) {
            ...
            if (projectile1.checkCollision(ballista2)) {
                std::cout << "Player 1 hits! Player 1 wins!\n";
                exit(0);
            }
            else if (projectile1.y < -WinHei / 2) {
        ...
        if (projectile2.shooting) {
            ...
            if (projectile2.checkCollision(ballista1)) {
                std::cout << "Player 2 hits! Player 2 wins!\n";
                exit(0);
            }
            else if (projectile2.y < -WinHei / 2) {
...
int main(int argc, char** argv) {
    ...
    glutCreateWindow("Ballistic Game");
